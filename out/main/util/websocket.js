...
var Connection = /** @class */ (function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        device = _a.sent();
                                        if (device) {
                                            url = "ws://".concat(device.LOCATION.split('//')[1]);
                                            ...
                                            ws_1.on('error', function (err) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                            ...
                                            ws_1.on('close', function () { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
    ...
    Connection.prototype.send = function (message) {
        ...
        if (this.server) {
            ...
            if (this.server.clients.size === 0 && !this.delinquentServerCloseTimeout) {
                ...
                this.delinquentServerCloseTimeout = setTimeout(function () {
                    var _a;
                    (_a = _this.server) === null || _a === void 0 ? void 0 : _a.close();
                    _this.delinquentServerCloseTimeout = null;
                }, 15000);
            }
            if (this.server.clients.size > 0 && this.delinquentServerCloseTimeout) {
    ...
    Connection.prototype.createWebSocketServer = function () {
        ...
        return new Promise(function (resolve) {
            try {
                var wss_1 = new WebSocket.Server({ port: config_1.PORT });
    ...
    Connection.prototype.searchForServer = function (searchTarget) {
        ...
        return new Promise(function (resolve) {
            ...
            client.on('response', function (headers) {
                if (headers.LOCATION.includes(":".concat(config_1.PORT, "/")))
                    resolve(headers);
            });
