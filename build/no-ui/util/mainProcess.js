      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          connection.listen(function (message) {
            console.log(message)
            if (
              (message === null || message === void 0 ? void 0 : message.type) === 'midi' &&
              (message === null || message === void 0 ? void 0 : message.data)
            ) {
              var _a = message.data,
                notePositionRatio = _a.notePositionRatio,
                noteVelocityRatio = _a.noteVelocityRatio,
                midiChannel = _a.midiChannel
              // note
              if (midiChannel === 144) {
                rgbStrip.setPixelColor.apply(
                  rgbStrip,
                  __spreadArray([notePositionRatio, noteVelocityRatio === 0 ? 0 : 1], COLOR, false)
                )
              }
              // pedal
              if (midiChannel === 176) {
