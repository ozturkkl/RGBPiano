...
var RgbStrip = /** @class */ (function () {
    ...
    RgbStrip.prototype.setPixelColor = function (pixelPositionRatio, velocityRatio, red, green, blue) {
        ...
        var blendedColor = color_1["default"].rgb(Math.round(red * velocityRatio) + Math.round(bgColor[0] * (1 - velocityRatio)), Math.round(green * velocityRatio) + Math.round(bgColor[1] * (1 - velocityRatio)), Math.round(blue * velocityRatio) + Math.round(bgColor[2] * (1 - velocityRatio)));
    ...
    RgbStrip.prototype.handleNotePress = function (data) {
        ...
        if (data.midiChannel === 144) {
            ...
            this.setPixelColor.apply(this, __spreadArray([data.notePositionRatio, data.noteVelocityRatio], (0, config_1.getConfig)().COLOR, false));
        }
        // pedal
